#
#  Be sure to run `pod spec lint LiveFader.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "LiveFader"
  spec.version      = "0.0.1"
  spec.summary      = "@IBDesignable Horizontal or vertical fader that can start from bottom or middle of the control."
...
* `LiveFaderView` is an open class, so you can subclass it to make it look anything you want, by playing with it's layers or adding new ones.
  ...
  spec.homepage     = "https://github.com/cemolcay/LiveFader"
  ...
  spec.source       = { :git => "https://github.com/cemolcay/LiveFader.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "LiveFader/LiveFader.swift"
